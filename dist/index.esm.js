...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, variant: "tertiary", color: variant === variants$3.PRIMARY ? "light" : variant === variants$3.TERTIARY ? 'tertiary' : "primary" }, props)));
    }
